...
public class FeatureViewEngine extends FeatureViewEngineBase<Query, FeatureView, FeatureStore, StreamFeatureGroup,
  ...
  @Override
  public String getBatchQueryString(FeatureView featureView, Date date, Date date1, Integer integer)
      throws FeatureStoreException, IOException {
    throw new UnsupportedOperationException("Not supported for Flink");
  }

  @Override
  public FeatureView getOrCreateFeatureView(FeatureStore featureStore, String s, Integer integer, Query query,
      String s1, List<String> list) throws FeatureStoreException, IOException {
    throw new UnsupportedOperationException("Not supported for Flink");
  }

  @Override
  public DataStream getBatchData(FeatureView featureView, Date date, Date date1, Map<String, String> map,
