...
public abstract class StorageConnector {
  ...
  public static class RedshiftConnector extends StorageConnector {
    ...
    public HsfsSparkBatch read(String query, String dataFormat, Map<String, String> options, String path)
      ...
      return SparkEngine.getInstance().sparkHsfsData(
          SparkEngine.getInstance().read(this, Constants.JDBC_FORMAT, readOptions, null));
    }
  ...
  public static class SnowflakeConnector extends StorageConnector {
    ...
    public HsfsSparkBatch read(String query, String dataFormat, Map<String, String> options, String path)
      ...
      return SparkEngine.getInstance().sparkHsfsData(
          SparkEngine.getInstance().read(this, Constants.SNOWFLAKE_FORMAT, readOptions, null));
    }
  ...
  public static class KafkaConnector extends StorageConnector {
    ...
    public HsfsSparkBatch readStream(String topic, boolean topicPattern, String messageFormat, String schema,
      ...
      return SparkEngine.getInstance().sparkHsfsData(
          SparkEngine.getInstance().readStream(this, sparkFormat, messageFormat.toLowerCase(),
