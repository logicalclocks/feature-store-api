...
public class OnlineFeatureGroup implements FeatureGroup {
  ...
  public OnlineFeatureGroup(FeatureStore featureStore, String name, Integer version, String description)
