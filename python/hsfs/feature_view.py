...
class FeatureView:
    ...
    def get_batch_data(self, start_time=None, end_time=None, read_options=None):
        """
        start_time: timestamp in second or wallclock_time: datatime.datetime, datetime.date,
            unix time in seconds (int), or string. The String should be formatted in one of the following formats
            `%Y%m%d`, `%Y%m%d%H`, `%Y%m%d%H%M`, `%Y%m%d%H%M%S`, or `%Y%m%d%H%M%S%f`.
        end_time: timestamp in second or wallclock_time: datatime.datetime, datetime.date,
            unix time in seconds (int), or string. The String should be formatted in one of the following formats
            `%Y%m%d`, `%Y%m%d%H`, `%Y%m%d%H%M`, `%Y%m%d%H%M%S`,  or `%Y%m%d%H%M%S%f`.
    ...
    def create_training_data(
        ...
        # Arguments
            start_time: timestamp in second or wallclock_time: datatime.datetime, datetime.date,
                unix time in seconds (int), or string.. The String should be formatted in one of the following
    ...
    def create_train_test_split(
        ...
        # Arguments
            ...
            train_start: timestamp in second or wallclock_time: datatime.datetime, datetime.date,
                unix time in seconds (int), or string. The String should be formatted in one of the following
                formats `%Y%m%d`, `%Y%m%d%H`, `%Y%m%d%H%M`, `%Y%m%d%H%M%S`,
                or `%Y%m%d%H%M%S%f`.
            train_end: timestamp in second or wallclock_time: datatime.datetime, datetime.date,
                unix time in seconds (int), or string. The String should be formatted in one of the following
                formats `%Y%m%d`, `%Y%m%d%H`, `%Y%m%d%H%M`, `%Y%m%d%H%M%S`,
                or `%Y%m%d%H%M%S%f`.
            test_start: timestamp in second or wallclock_time: datatime.datetime, datetime.date,
                unix time in seconds (int), or string. The String should be formatted in one of the following
                formats `%Y%m%d`, `%Y%m%d%H`, `%Y%m%d%H%M`, `%Y%m%d%H%M%S`,
                or `%Y%m%d%H%M%S%f`.
            test_end: timestamp in second or wallclock_time: datatime.datetime, datetime.date,
                unix time in seconds (int), or string. The String should be  formatted in one of the following
                formats `%Y%m%d`, `%Y%m%d%H`, `%Y%m%d%H%M`, `%Y%m%d%H%M%S`,
                or `%Y%m%d%H%M%S%f`.
            storage_connector: Storage connector defining the sink location for the
    ...
    def create_train_validation_test_split(
        ...
        # Arguments
            ...
            train_end: timestamp in second or wallclock_time: datatime.datetime, datetime.date,
                ...
                formats `%Y%m%d`, `%Y%m%d%H`, `%Y%m%d%H%M`, `%Y%m%d%H%M%S`,
                or `%Y%m%d%H%M%S%f`.
            validation_start: timestamp in second or wallclock_time: datatime.datetime, datetime.date,
                unix time in seconds (int), or string. The String should be formatted in one of the following
                formats `%Y%m%d`, `%Y%m%d%H`, `%Y%m%d%H%M`, `%Y%m%d%H%M%S`,
                or `%Y%m%d%H%M%S%f`.
            validation_end: timestamp in second or wallclock_time: datatime.datetime, datetime.date,
                unix time in seconds (int), or string. The String should be formatted in one of the following
                formats `%Y%m%d`, `%Y%m%d%H`, `%Y%m%d%H%M`, `%Y%m%d%H%M%S`,
                or `%Y%m%d%H%M%S%f`.
            test_start: timestamp in second or wallclock_time: datatime.datetime, datetime.date,
    ...
    def train_test_split(
        ...
        # Arguments
            ...
            train_start: timestamp in second or wallclock_time: datatime.datetime, datetime.date, unix time in
                seconds (int), or string. The String should be formatted in one of the following formats `%Y%m%d`,
