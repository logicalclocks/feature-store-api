...
class FeatureMonitoringConfigEngine:
    ...
    def enable_descriptive_statistics_monitoring(
        ...
        name: str,
        feature_name: str,
        detection_monitoring_window_configuration: Dict[str, Any],
    ...
    def enable_feature_monitoring_config(
        ...
        name: str,
        detection_monitoring_window_configuration: Dict[str, Any],
        reference_monitoring_window_configuration: Dict[str, Any],
        descriptive_statistics_comparison_configuration: Dict[str, Any],
        alert_config: str,
        scheduler_config: str,
        description: Optional[str] = None,
        feature_group_id: Optional[int] = None,
        ...
        config = self.build_feature_monitoring_config(
            ...
            descriptive_statistics_comparison_configuration=descriptive_statistics_comparison_configuration,
            scheduler_config=scheduler_config,
    ...
    def build_monitoring_window_config(
        ...
        return {
            "window_configuration_type": window_configuration_type,
    ...
    def build_stats_monitoring_only_config(
        ...
        return FeatureMonitoringConfig(
            ...
            descriptive_statistics_comparison_configuration=None,
        )
