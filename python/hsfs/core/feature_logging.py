...
class FeatureLogging:
    ...
    def from_response_json(cls, json_dict: Dict[str, Any]) -> 'FeatureLogging':
        ...
        if transformed_features:
            transformed_features = feature_group.FeatureGroup.from_response_json(transformed_features)
        if untransformed_features:
            untransformed_features = feature_group.FeatureGroup.from_response_json(untransformed_features)
