...
class FeedModelEngine:
    ...
    def tf_record_dataset(
        ...
        :param one_hot_encode_labels: if set true then one hot encode lables
        :param num_classes: if above true then provide number of target classes
        :param optimize: if set true  api will optimise tf data read operation
