...
from hsfs import feature_view, transformation_function_attached, training_dataset, split_statistics
...
class TestFeatureViewEngine:
    ...
    def test_save(self, mocker):
        ...
        mock_tf_engine = mocker.patch('hsfs.core.transformation_function_engine.TransformationFunctionEngine')
        ...
        assert mock_print.call_args.args[0] == 'Feature view created successfully, explore it at \n{}'.format(feature_view_url)
    ...
    def test_get_name(self, mocker):
        ...
        mock_fv_api = mocker.patch('hsfs.core.feature_view_api.FeatureViewApi')
        mock_fv_engine_get_attached_transformation_fn = mocker.patch('hsfs.core.feature_view_engine.FeatureViewEngine.get_attached_transformation_fn')
        ...
        fv = feature_view.FeatureView(name='fv_name',
                                      ...
                                      featurestore_id=feature_store_id,
                                      labels=[])
        fv1 = feature_view.FeatureView(name='fv_name',
                                       version=2,
                                       query='fv_query',
                                       featurestore_id=feature_store_id,
                                       labels=[])
    ...
    def test_get_batch_query(self, mocker):
        ...
        # Act
        fv_engine.get_batch_query(feature_view_obj=fv, start_time=1, end_time=2, with_label=False)
    ...
    def test_get_batch_query_string(self, mocker):
        ...
        mock_fv_api = mocker.patch('hsfs.core.feature_view_api.FeatureViewApi')
        mock_qc_api_construct_query = mocker.patch('hsfs.core.query_constructor_api.QueryConstructorApi.construct_query')
        mocker.patch('hsfs.engine.get_type')
        ...
        fv = feature_view.FeatureView(name='fv_name',
                                      ...
                                      featurestore_id=feature_store_id,
                                      labels=[])
        query = fs_query.FsQuery(query="query",
        ...
        # Act
        result = fv_engine.get_batch_query_string(feature_view_obj=fv, start_time=1, end_time=2)
    ...
    def test_create_training_dataset(self, mocker):
        ...
        mock_fv_engine_create_training_data_metadata = mocker.patch('hsfs.core.feature_view_engine.FeatureViewEngine._create_training_data_metadata')
        mock_fv_engine_compute_training_dataset = mocker.patch('hsfs.core.feature_view_engine.FeatureViewEngine.compute_training_dataset')

        fv_engine = feature_view_engine.FeatureViewEngine(feature_store_id=feature_store_id)

        # Act
        fv_engine.create_training_dataset(feature_view_obj=None, training_dataset_obj=None, user_write_options=None)
    ...
    def test_get_training_data(self, mocker):
        ...
        mocker.patch('hsfs.core.feature_view_api.FeatureViewApi')
        mock_fv_engine_get_training_data_metadata = mocker.patch('hsfs.core.feature_view_engine.FeatureViewEngine._get_training_data_metadata')
        mock_fv_engine_create_training_data_metadata = mocker.patch('hsfs.core.feature_view_engine.FeatureViewEngine._create_training_data_metadata')
        mock_engine_get_instance = mocker.patch('hsfs.engine.get_instance')
        mock_fv_engine_read_from_storage_connector = mocker.patch('hsfs.core.feature_view_engine.FeatureViewEngine._read_from_storage_connector')
        mock_fv_engine_check_feature_group_accessibility = mocker.patch('hsfs.core.feature_view_engine.FeatureViewEngine._check_feature_group_accessibility')
        mock_fv_engine_get_batch_query = mocker.patch('hsfs.core.feature_view_engine.FeatureViewEngine.get_batch_query')
        mock_fv_engine_compute_training_dataset_statistics = mocker.patch('hsfs.core.feature_view_engine.FeatureViewEngine.compute_training_dataset_statistics')
    ...
    def test_get_training_data_type_in_memory(self, mocker):
        ...
        mock_fv_engine_create_training_data_metadata.return_value.IN_MEMORY = training_dataset.TrainingDataset.IN_MEMORY
        mock_fv_engine_create_training_data_metadata.return_value.splits = []
    ...
    def test_get_training_data_check_splits_0(self, mocker):
        ...
        # Assert
        assert str(e_info.value) == "Incorrect `get` method is used. Use `feature_view.get_training_data` instead."
        assert mock_fv_engine_get_training_data_metadata.call_count == 0
        assert mock_fv_engine_create_training_data_metadata.call_count == 1
    ...
    def test_get_training_data_check_splits_2(self, mocker):
        ...
        # Assert
        assert str(e_info.value) == "Incorrect `get` method is used. Use `feature_view.get_train_test_split` instead."
        assert mock_fv_engine_get_training_data_metadata.call_count == 0
    ...
    def test_get_training_data_check_splits_3(self, mocker):
        ...
        # Assert
        assert str(e_info.value) == "Incorrect `get` method is used. Use `feature_view.get_train_validation_test_split` instead."
        assert mock_fv_engine_get_training_data_metadata.call_count == 0
        assert mock_fv_engine_create_training_data_metadata.call_count
        assert mock_engine_get_instance.return_value.read_options.call_count == 0
        assert mock_engine_get_instance.return_value.get_training_data.call_count == 0
    ...
    def test_recreate_training_dataset(self, mocker):
        ...
        # Act
        fv_engine.recreate_training_dataset(feature_view_obj=None, training_dataset_version=None, user_write_options=None)
    ...
    def test_read_from_storage_connector(self, mocker):
        ...
        mocker.patch('hsfs.core.feature_view_api.FeatureViewApi')
        mock_fv_engine_read_dir_from_storage_connector = mocker.patch('hsfs.core.feature_view_engine.FeatureViewEngine._read_dir_from_storage_connector')
        ...
        # Act
        fv_engine._read_from_storage_connector(training_data_obj=td, splits=None, read_options=None)

        # Assert
        assert mock_fv_engine_read_dir_from_storage_connector.call_count == 1
        assert mock_fv_engine_read_dir_from_storage_connector.call_args.args[1] == 'location/test'
    ...
    def test_read_from_storage_connector_splits(self, mocker):
        ...
        # Act
        fv_engine._read_from_storage_connector(training_data_obj=td, splits=splits, read_options=None)

        # Assert
        assert mock_fv_engine_read_dir_from_storage_connector.call_count == 2
        assert mock_fv_engine_read_dir_from_storage_connector.mock_calls[0].args[1] == 'location/ss'
        assert mock_fv_engine_read_dir_from_storage_connector.mock_calls[1].args[1] == 'location/ss1'
    ...
    def test_read_dir_from_storage_connector(self, mocker):
        ...
        # Act
        fv_engine._read_dir_from_storage_connector(training_data_obj=td, path="test", read_options=None)
    ...
    def test_read_dir_from_storage_connector_file_not_found(self, mocker):
        ...
        mocker.patch('hsfs.core.feature_view_api.FeatureViewApi')
        mock_sc_read = mocker.patch('hsfs.storage_connector.StorageConnector.read', side_effect=FileNotFoundError())
        ...
        # Assert
        assert str(e_info.value) == "Failed to read dataset from test. Check if path exists or recreate a training dataset."
        assert mock_sc_read.call_count == 1
    ...
    def test_compute_training_dataset(self, mocker):
        ...
        mock_code_engine_save_code = mocker.patch('hsfs.core.code_engine.CodeEngine.save_code')
        mock_td_engine_read = mocker.patch('hsfs.core.training_dataset_engine.TrainingDatasetEngine.read')
        mock_fv_engine_compute_training_dataset_statistics = mocker.patch('hsfs.core.feature_view_engine.FeatureViewEngine.compute_training_dataset_statistics')
        ...
        # Act
        with pytest.raises(ValueError) as e_info:
            fv_engine.compute_training_dataset(feature_view_obj=None,
    ...
    def test_compute_training_dataset_statistics(self, mocker):
        ...
        mocker.patch('hsfs.core.feature_view_api.FeatureViewApi')
        mock_s_engine_register_split_statistics = mocker.patch('hsfs.core.statistics_engine.StatisticsEngine.register_split_statistics')
        mock_s_engine_compute_statistics = mocker.patch('hsfs.core.statistics_engine.StatisticsEngine.compute_statistics')
        ...
        # Act
        fv_engine.compute_training_dataset_statistics(feature_view_obj=None, training_dataset_obj=td, td_df=None, calc_stat=False)
    ...
    def test_compute_training_dataset_statistics_enabled_calc_stat(self, mocker):
        ...
        # Act
        fv_engine.compute_training_dataset_statistics(feature_view_obj=None, training_dataset_obj=td, td_df=None, calc_stat=True)
    ...
    def test_compute_training_dataset_statistics_enabled_calc_stat_splits(self, mocker):
        ...
        # Assert
        assert str(e_info.value) == "Provided dataframes should be in dict format 'split': dataframe"
        assert mock_s_engine_register_split_statistics.call_count == 0
        assert mock_s_engine_compute_statistics.call_count == 0
    ...
    def test_compute_training_dataset_statistics_enabled_calc_stat_splits_td_df(self, mocker):
        # Arrange
        feature_store_id = 99
        ...
        # Act
        fv_engine.compute_training_dataset_statistics(feature_view_obj=None, training_dataset_obj=td, td_df={}, calc_stat=True)
    ...
    def test_get_training_data_metadata(self, mocker):
        ...
        # Act
        result = fv_engine._get_training_data_metadata(feature_view_obj=fv, training_dataset_version=None)
    ...
    def test_create_training_data_metadata(self, mocker):
        ...
        # Act
        result = fv_engine._create_training_data_metadata(feature_view_obj=fv, training_dataset_obj=None)
    ...
    def test_delete_training_dataset_only(self, mocker):
        ...
        # Act
        fv_engine.delete_training_dataset_only(feature_view_obj=fv, training_data_version=None)

        # Assert
        assert mock_fv_api.return_value.delete_training_dataset_only_version.call_count == 0
    ...
    def test_delete_training_dataset_only_version(self, mocker):
        ...
        # Act
        fv_engine.delete_training_dataset_only(feature_view_obj=fv, training_data_version=1)

        # Assert
        assert mock_fv_api.return_value.delete_training_dataset_only_version.call_count == 1
    ...
    def test_get_batch_data(self, mocker):
        ...
        # Act
        fv_engine.get_batch_data(feature_view_obj=None,
                                 start_time=None,
                                 end_time=None,
                                 training_dataset_version=None,
        ...
        # Assert
        assert mock_engine_get_instance.return_value._apply_transformation_function.call_args.args[0].transformation_functions == tf_value
        assert mock_fv_engine_check_feature_group_accessibility.call_count == 1
        assert mock_fv_engine_get_batch_query.call_count == 1
        assert mock_fv_engine_get_training_data_metadata.call_count == 1
    ...
    def test_add_tag(self, mocker):
        ...
        # Act
        fv_engine.add_tag(feature_view_obj=None, name=None, value=None, training_dataset_version=None)
    ...
    def test_delete_tag(self, mocker):
        ...
        # Act
        fv_engine.delete_tag(feature_view_obj=None, name=None, training_dataset_version=None)
    ...
    def test_get_tag(self, mocker):
        ...
        # Act
        fv_engine.get_tag(feature_view_obj=None, name=None, training_dataset_version=None)
    ...
    def test_check_feature_group_accessibility_get_type_python(self, mocker):
        ...
        # Assert
        assert str(e_info.value) == "Python kernel can only read from cached feature group. Please use `feature_view.create_training_data` instead."
    ...
    def test_check_feature_group_accessibility_cache_feature_group_get_type_python(self, mocker):
        # Arrange
        feature_store_id = 99
    ...
    def test_check_feature_group_accessibility_cache_feature_group_get_type_hive(self, mocker):
        # Arrange
        feature_store_id = 99
    ...
    def test_get_feature_view_url(self, mocker):
        ...
        assert mock_util_get_hostname_replaced_url.call_args.args[0] == '/p/50/fs/99/fv/fv_name/version/1'
